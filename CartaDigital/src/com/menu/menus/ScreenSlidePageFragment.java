...
public class ScreenSlidePageFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		 ...
		 * 
		 * rootView = (ViewGroup)
		 * inflater.inflate(R.layout.vista_vertical_bebidas, container, false);
		 * 
		 * }
		 * 
		 * if (mPageNumber == 1) {
		 * 
		 * rootView = (ViewGroup)
		 * inflater.inflate(R.layout.vista_vertical__vinos, container, false);
		 * 
		 * }
		 * 
		 * if (mPageNumber == 2) {
		 * 
		 * rootView = (ViewGroup)
		 * inflater.inflate(R.layout.vista_vertical_entrantes, container,
		 * false);
		 * 
		 * }
		 * 
		 ...
		 * 
		 * rootView = (ViewGroup)
		 * inflater.inflate(R.layout.vista_vertical_com_tradicional, container,
		 * false);
		 * 
		 * }
		 * 
		 ...
		 * 
		 * rootView = (ViewGroup)
		 * inflater.inflate(R.layout.vista_vertical_pescados, container, false);
		 * 
		 * }
		 * 
		 * if (mPageNumber == 5) {
		 ...
		 * 
		 * rootView = (ViewGroup)
		 * inflater.inflate(R.layout.vista_vertical_carnes, container, false);
		 * 
		 * }
		 * 
		 * if (mPageNumber == 6) {
		 ...
		 * 
		 * rootView = (ViewGroup)
		 * inflater.inflate(R.layout.vista_vertical_comanda, container, false);
		 * 
		 * }
		 * 
